        ...
        <AnimatedContent distance={50} direction="vertical">
          <div className="text-center mb-16">
            ...
            <p className="text-neutral-gray text-lg max-w-2xl mx-auto">
              A journey through my professional career, showcasing key roles and
          ...
          <div className="space-y-12 lg:space-y-0">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Period label - opposite side of card */}
                <div
                ...
                {/* Single connecting line to next card */}
                {index < experiences.length - 1 && (
                  <div className="hidden lg:block absolute left-1/2 top-[calc(50%+0.5rem)] -translate-x-1/2 w-px h-[calc(50%+2.5rem)] bg-accent-blue/30 z-0" />
                )}

                {/* Single connecting line from previous card */}
                {index > 0 && (
                  <div className="hidden lg:block absolute left-1/2 bottom-[calc(50%+0.5rem)] -translate-x-1/2 w-px h-[calc(50%+2.5rem)] bg-accent-blue/30 z-0" />
                )}
