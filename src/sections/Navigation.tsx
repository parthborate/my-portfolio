        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center h-16 lg:h-20">
            ...
            <a
              ...
              className="absolute left-6 text-xl font-display font-bold text-white hover:text-accent-cyan transition-colors"
            >
            ...
            <button
              ...
              className="lg:hidden absolute right-6 w-10 h-10 flex items-center justify-center text-white"
