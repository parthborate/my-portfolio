      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <AnimatedContent distance={80} direction="horizontal" delay={0.2}>
            <SpotlightCard className="p-6 sm:p-8" spotlightColor="rgba(0, 229, 255, 0.15)">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        borderColor: focusedField === 'name' ? '#00e5ff' : undefined,
                      }}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-transparent border-b-2 border-white/20 text-white py-2 focus:outline-none transition-colors"
                      style={{
                        borderColor: focusedField === 'email' ? '#00e5ff' : undefined,
                      }}
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      style={{
                        borderColor: focusedField === 'message' ? '#00e5ff' : undefined,
                      }}
